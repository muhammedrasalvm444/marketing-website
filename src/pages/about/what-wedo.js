...
const WhatWeDo = () => {
  ...
  return (
    <div className="mx-4 my-5">
      <h1 className="font-semibold text-center text-7xl text-secondary sm:text-6xl sm:mt-8">
        What We Do ?
      </h1>
      <div className="w-full mt-10 h-96 bg-primary sm:hidden "></div>
      <div className="grid grid-cols-4 gap-10 px-32 mx-1 sm:px-2 sm:grid-cols-1 -mt-60 sm:mt-24">
        {list?.map((item) => {
          return (
